#!/bin/bash
# =====================================================
#  Arch Linux Installer: ThinkPad T470 (v8 Final Fix)
#  - Fix: Runs 'pacman -Syu' inside chroot to fix libalpm error
#  - Fix: Creates /etc/iwd directory before writing config
#  - Fix: Uses built-in Reflector (safe mode)
# =====================================================
...
clear
echo "=========================================="
echo "   THINKPAD T470 ARCH INSTALLER (v8)"
echo "=========================================="
...
# -------------------------------
echo ":: CRITICAL: Updating system libraries before building Paru..."
# This fixes the libalpm.so.15 error by ensuring libraries match the build environment
